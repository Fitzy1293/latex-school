...
%======================================================================================================================================================
\section{Problem 3}
\emph{The binomial theorem states - binomail theorem here.
(a) Show that if n is a positive integer, this infinite series terminates (that is, has
only a finite number of nonzero terms). Write the series down explicitly for the
cases n = 2 and n = 3. (b) Write down the binomial series for the case n = -1.
This case gives an infinite series for 1/(1 + x), but when xis small, you get a good
...
\subsection*{\emph{Solution 3.8\\Section 3.3: Abnormal number of cancer cases?}}
